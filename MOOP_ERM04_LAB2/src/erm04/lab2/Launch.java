...
import static erm04.lab2.CNotepad.createNewNotepadWriter;
import static erm04.lab2.CNotepad.createNewNotepadDataset;
...
//            soureList.add(createNewNotepadDataset("vertherth", 2, 21));// Готовый набор данных
        ...
        set.add(new CNotepad("AEl 2", 1, 55));// Готовый набор данных
        set.add(new CNotepad("Paper 1", 2, 26));// Готовый набор данных
        set.add(new CNotepad("El 1", 1, 55));// Готовый набор данных
//            
